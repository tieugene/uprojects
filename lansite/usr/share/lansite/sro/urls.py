...
urlpatterns = patterns('lansite.sro.views',
	...
	(r'^journal/$',							'journal'),
	(r'^org/$',							'org_list'),
	(r'^org/publish_s/$',						'org_publish_s'),
	(r'^org/upload_s/$',						'org_upload_s'),
	(r'^org/publish_p/$',						'org_publish_p'),
	(r'^org/upload_p/$',						'org_upload_p'),
	(r'^org/table/$',						'org_table'),
	(r'^org/mailto/$',						'org_mailto'),
	(r'^org/(?P<org_id>\d+)/$',					'org_view'),
	(r'^org/(?P<org_id>\d+)/svid/$',				'org_svid_pdf'),
	(r'^org/(?P<org_id>\d+)/extract/$',				'org_extract'),
	(r'^org/(?P<org_id>\d+)/prj/$',				'org_prj_pdf'),
	...
	(r'^org/(?P<org_id>\d+)/edit/permit/(?P<type_id>\d+)/add/$',	'org_edit_permit_add'),
	...
	(r'^permit/(?P<perm_id>\d+)/dup/$',				'permit_dup'),
	(r'^permit/(?P<perm_id>\d+)/dup/(?P<type_id>\d+)/$',		'permit_dup_edit'),
	(r'^permit/(?P<perm_id>\d+)/cmp/$',				'permit_cmp'),
