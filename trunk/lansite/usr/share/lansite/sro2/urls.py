...
urlpatterns = patterns('sro2.views',
	...
	(r'^sro/(?P<sro_id>\d+)/list/(?:(?P<page_num>\d+)/)?$',	'sro_list'),
	(r'^sro/(?P<sro_id>\d+)/publish/$',				'sro_publish'),
	(r'^sro/(?P<sro_id>\d+)/publish/member/(?P<item_id>\d+).html$',		'sro_publish_member'),
	...
	(r'^sro/(?P<sro_id>\d+)/find/$',				'sro_find'),
	(r'^sro/(?P<sro_id>\d+)/find/(?P<stage_id>\d+)/$',		'sro_find_filter'),
	...
	(r'^sro/(?P<sro_id>\d+)/person/list/(?:(?P<page_num>\d+)/)?$',			'person_list'),
