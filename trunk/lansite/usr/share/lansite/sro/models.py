...
class	Person(models.Model):
	...
	scills		= models.ManyToManyField(Skill, through='PersonSkill', verbose_name=u'Квалификации')
...
modellist = (
	...
	PersonSkill, PersonFile, Org, OrgOkved, Permit, PermitStage, PermitStageJob, OrgPhone, OrgEmail, OrgEvent,
	OrgStuff, OrgFile, Meeting, MeetingOrg
)
