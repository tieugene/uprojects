...
public:
    ...
    MainWindowClass->resize(376, 299);
    QIcon icon;
    ...
    menuBar->setGeometry(QRect(0, 0, 376, 24));
    ...
    tableWidget->horizontalHeaderItem(0)->setText(QApplication::translate("MainWindowClass", "Type", 0, QApplication::UnicodeUTF8));
    tableWidget->horizontalHeaderItem(1)->setText(QApplication::translate("MainWindowClass", "Org", 0, QApplication::UnicodeUTF8));
    tableWidget->horizontalHeaderItem(2)->setText(QApplication::translate("MainWindowClass", "Comments", 0, QApplication::UnicodeUTF8));
